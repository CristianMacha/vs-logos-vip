export default function DescriptionMain() {
    return (
        <div>
            <div>
                <h2 className="text-center text-4xl text-vs-blue font-bold py-4">
            ...
            <div className="bg-gradient-to-r from-vs-blue via-vs-blue to-[#0053c1] py-4 rounded-t-3xl w-full">
                <p className="px-16 lg:px-48 text-white text-center text-sm">
                    ...
                    personalizado como: flyers, tarjetas de visita, hojas
                    membretadas, animacion en 3D y 2D. En Logos VIP brindamos un
                    servicio de alta calidad, logrando llegar a las espectativas
